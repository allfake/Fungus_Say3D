...
{
    [CustomEditor (typeof(Character3D))]
    public class Character3DEditor : Editor
    {
        ...
        protected SerializedProperty setModel3D;
        protected SerializedProperty setAnimator;
        ...
        protected virtual void OnEnable()
        {
            ...
            setModel3D = serializedObject.FindProperty("model3D");
            setAnimator = serializedObject.FindProperty("animator");
        }
        ...
        public override void OnInspectorGUI() 
        {
            ...
            EditorGUILayout.PropertyField(setModel3D);
